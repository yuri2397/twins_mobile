...
class OfferScreen extends GetView<OfferController> {
  ...
  Widget build(BuildContext context) {
    return Obx(() => Scaffold(
        ...
        body: controller.offerLoad.value ? const Center( child: CircularProgressIndicator(color: MAIN_COLOR),) : Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                GestureDetector(
                  onTap: () => controller.choosePlan(controller.offers[0]),
                  child: Container(
                    width: Get.width * .3,
                    height: 170,
                ...
                GestureDetector(
                  onTap: () => controller.choosePlan(controller.offers[1]),
                  child: Container(
                    width: Get.width * .3,
                    height: 170,
                    margin: const EdgeInsets.symmetric(horizontal: 2),
                ...
                GestureDetector(
                  onTap: () => controller.choosePlan(controller.offers[2]),
                  child: Container(
                    width: Get.width * .3,
                    height: 170,
